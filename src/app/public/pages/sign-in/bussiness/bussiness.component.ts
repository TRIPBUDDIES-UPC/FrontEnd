...
import {BussinessModel} from "../../../model/BussinessModel";
...
export class BussinessComponent implements OnInit{
  ...
  Add(){
    ...
    this.Bussiness.description =  'I am a recruiter';
    this.Bussiness.email =  this.registerForm.get('email')?.value;
    this.Bussiness.firstName =  this.registerForm.get('first_name')?.value;
    this.Bussiness.image = 'https://d500.epimg.net/cincodias/imagenes/2016/07/04/lifestyle/1467646262_522853_1467646344_noticia_normal.jpg';
